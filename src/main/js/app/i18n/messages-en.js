...
export default {
    ...
    'app.rest.title': 'Rest',
    'app.organization.title': 'Organization',
    ...
    'app.page.organization.text.first': 'We get data from the database of the organization table from the server.',
    'app.page.organization.text.second': 'Implemented the ability to add and remove organization.',
    ...
    // Page Organizations
    'app.organization.table.title': 'Organization',
    'app.organization.table.id': 'ID',
    'app.organization.table.name': 'Name',
    'app.organization.table.form': 'Form',
    'app.organization.table.capital': 'Capital',
    'app.organization.table.delete': 'Delete',
    'app.organization.table.add': 'Add organization',
